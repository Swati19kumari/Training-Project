...
<body>
    <div class="container">
        ...
        <h2>Show Patient by Doctor ID</h2>
        ...
        <h:messages globalOnly="true" style="color:red; font-weight:bold;" />
            ...
            <div class="form-grid">
                ...
                <h:commandButton value="Search" action="#{doctorController.ShowPatientByDocId}" />
            </div>

            <h:dataTable value="#{doctorController.patientList}" var="patient"
                border="0" rendered="#{not empty doctorController.patientList}">
